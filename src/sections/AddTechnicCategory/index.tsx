...
export function AddtechnicCategory({ styleFormData }: Props) {
  ...
  const defaultValues = useMemo(
    () => ({
       technicTitle: styleFormData?.technicTitle || '',
       technicCategory:styleFormData?.technicCategory || [],
    }),
    [styleFormData]
  );
  ...
  const renderDetails = (
    <Card>
      <CardHeader title="Technics"  sx={{mb:2}}/>
      ...
      <Box
        ...
        >
          ...
          <Field.Text name="technicTitle" label="Title"/>
