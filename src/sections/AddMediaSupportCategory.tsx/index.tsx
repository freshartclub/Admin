...
export const NewProductSchema = zod.object({
    mediaSupportTitle:zod.string().min(1, { message: 'Title is required!' }),
    mediaSupportCategory: zod.string().array().nonempty({ message: 'Choose at least one option!' }),
...
export function AddMediaSupportCategory({ styleFormData }: Props) {
  ...
  const defaultValues = useMemo(
    () => ({
       mediaSupportTitle: styleFormData?.mediaSupportTitle || '',
        mediaSupportCategory:styleFormData?.mediaSupportCategory || [],
    }),
    [styleFormData]
  );
    ...
    <Card>
      ...
      <Box
        ...
        >
          ...
          <Field.Text name="mediaSupportTitle" label="Title"/>

          <Field.Autocomplete
          name="mediaSupportCategory"
          label="Categorys"
