...
export function MessageItem({ notification }: { notification: NotificationItemProps }) {
  const renderAvatar = (
    <ListItemAvatar>
  ...
  return (
    ...
    >
      ...
      <Stack sx={{ flexGrow: 1 }}>
        {renderText}
        {notification.type === 'friend' && projectAction}
        {notification.type === 'project' && projectAction}
        {notification.type === 'file' && projectAction}
        {notification.type === 'tags' && projectAction}
        {notification.type === 'payment' && projectAction}
        {notification.type === 'payment' && projectAction}
        {notification.type === 'order' && projectAction}
        {notification.type === 'chat' && projectAction}
        {notification.type === 'mail' && projectAction}
        {notification.type === 'delivery' && projectAction}
      </Stack>
    </ListItemButton>
  );
}
