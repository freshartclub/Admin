        ...
        <EmptyContent
          ...
          action={
            <Button
              ...
              href={paths.dashboard.circle.new}
  ...
  return (
    <DashboardContent maxWidth={false} disablePadding>
      <Container maxWidth={false} sx={{ px: { sm: 5 } }}>
        <PostDetailsToolbar
          backLink={paths.dashboard.circle.root}
          editLink={paths.dashboard.circle.edit(`${post?.title}`)}
          liveLink={paths.dashboard.circle.details(`${post?.title}`)}
          publish={`${publish}`}
