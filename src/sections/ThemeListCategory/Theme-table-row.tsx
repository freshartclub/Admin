...
import useDeleteThemeMutation from './http/useDeleteThemeMutation';
    ...
    <>
      ...
      >
        <MenuList>
          ...
          <MenuItem onClick={() => navigate(`${paths.dashboard.category.theme.add}?id=${row._id}`)}>
      ...
      <ConfirmDialog
        ...
        action={
          <Button variant="contained" color="error" onClick={deleteTheme}>
